...
[source,java,indent=0]
----
include::example$03-shopping-cart-service-java/src/main/java/shopping/cart/ShoppingCart.java[tag=state]
----
...
----
FIXME
include::example$03-shopping-cart-service-java/src/main/java/shopping/cart/ShoppingCart.java[tag=checkoutCommandHandler]
----
